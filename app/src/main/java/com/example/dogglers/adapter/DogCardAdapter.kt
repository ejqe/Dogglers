...
class DogCardAdapter(
    ...
    private var dogList = DataSource.dogs
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val layoutSelector = when (layout) {
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogImage.setImageResource(currentItem.imageResourceId)
        holder.dogName.text = currentItem.name

        val resources = context?.resources

        holder.dogAge.text = resources?.getString(R.string.dog_age, currentItem.age)
        holder.dogHobbies.text = resources?.getString(R.string.dog_hobbies, currentItem.hobbies)
    }
